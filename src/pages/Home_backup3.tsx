    ...
    <div className={`relative bg-krim-deep-space overflow-x-hidden ${KRIM_FIX_WHITEFLASH_V1 ? 'isolate' : ''}`}>
      ...
      <section className="relative overflow-hidden py-20 md:py-28">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          ...
          >
            <p className="text-base md:text-lg text-white/70 mb-3">
              Krim AI introduces
            </p>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-4">
              Kendra — The Emergent Intelligence Substrate
            </h2>
          ...
          >
            ...
            >
              <h3 className="text-xl md:text-2xl font-semibold text-white mb-3">
                Expert AI Co-Workers
              </h3>
              <p className="text-white/80 text-base md:text-lg">
                Scale output, not cost.
              </p>
            </motion.div>
          ...
          {/* Micro-line: Autonomy with Governance */}
          <motion.p
            className="text-center text-base md:text-lg text-krim-mint/80 font-medium"
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: '-80px' }}
            transition={{ duration: 0.2, ease: [0.4, 0.0, 0.2, 1], delay: 0.28 }}
          >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-3">
              {['Campaign', 'Support', 'Legal', 'Field Ops'].map((center, i) => (
                <motion.span
                  key={center}
                  className="px-4 py-2 rounded-full border border-border/60 bg-card/40 backdrop-blur text-white text-sm md:text-base font-medium"
                  initial={{ opacity: 0, y: 24 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true, margin: '-80px' }}
                  transition={{ duration: 0.2, ease: [0.4, 0.0, 0.2, 1], delay: i * 0.05 }}
                >
                  {center}
                </motion.span>
              ))}
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['Compliance', 'Risk', 'Settlements', 'Enterprise'].map((center, i) => (
                <motion.span
                  key={center}
                  className="px-4 py-2 rounded-full border border-border/60 bg-card/40 backdrop-blur text-white text-sm md:text-base font-medium"
                  initial={{ opacity: 0, y: 24 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true, margin: '-80px' }}
                  transition={{ duration: 0.2, ease: [0.4, 0.0, 0.2, 1], delay: (i + 4) * 0.05 }}
                >
                  {center}
                </motion.span>
              ))}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: '-80px' }}
            transition={{ duration: 0.2, ease: [0.4, 0.0, 0.2, 1], delay: 0.4 }}
          >
            <p className="text-base md:text-lg text-white/70">Live oversight.</p>
            <p className="text-base md:text-lg text-white/70">Live intervention.</p>
            <p className="text-base md:text-lg text-white/70">Live intelligence.</p>
          </motion.div>
        </div>
      </section>

      {/* KULA ASSISTANT SECTION */}
      <section className="relative overflow-hidden py-20 md:py-28">
        {/* Background Elements */}
        <div className="absolute inset-0 pointer-events-none">
          <div className={`absolute inset-0 opacity-[0.03] bg-grid bg-[size:60px_60px] ${KRIM_FIX_WHITEFLASH_V1 ? 'z-0' : ''}`} />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-white/80 max-w-3xl mx-auto mb-8">
              Human-in-the-loop orchestration, design, analysis & approvals — through natural language.
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: '-80px' }}
                transition={{ duration: 0.2, ease: [0.4, 0.0, 0.2, 1], delay: i * 0.07 }}
              >
                <span className="text-krim-mint text-xl">•</span>
                <p className="text-base md:text-lg text-white/80">{item}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="relative overflow-hidden py-20 md:py-28">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          ...
          {/* Two Sub-Cards: Contact Center & Back-Office */}
          <motion.div
            className="grid md:grid-cols-2 gap-6 md:gap-8 mb-8"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            ...
            >
              ...
              <p className="text-white/80 text-base md:text-lg text-center">
          ...
          {/* Anchor Trio Line */}
          <motion.p
            className="text-center text-base md:text-lg text-white/70"
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: '-80px' }}
            transition={{ duration: 0.2, ease: [0.4, 0.0, 0.2, 1], delay: 0.14 }}
