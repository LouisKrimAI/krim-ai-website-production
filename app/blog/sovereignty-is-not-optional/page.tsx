/**
 * /blog/sovereignty-is-not-optional — article. STANDALONE shell.
            ...
            <Reveal>
              <div className="mt-14 border-t border-soft pt-8">
                ...
                <div className="mt-4 grid gap-3">
                  ...
                  <Link href="/blog/the-credit-gap-is-an-operations-problem" className="group font-serif text-[1.2rem] text-ink transition-colors hover:text-mint">
