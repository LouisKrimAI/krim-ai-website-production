/**
 * /blog/audit-after-the-fact-is-a-confession — article. STANDALONE shell.
          ...
          <div className="mx-auto max-w-[680px]">
            <Reveal>
              ...
              <Reveal>
                <GlassCard accent className="my-10 p-8 md:p-10">
                  <p className="font-serif text-[1.5rem] leading-snug text-ink">
                    The AI your regulator can read. Not a model that explains itself afterward — a
              ...
              <p className="mt-5 font-sans text-body text-ink-2">
                ...
                the match from being struck — and hands you, by construction, exactly the record a
