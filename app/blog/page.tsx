/**
 * /blog — the writing index. STANDALONE pattern (SiteHeader + OrbBackdrop +
 * main + SiteFooter), like app/research/page.tsx — NOT LayerShell.
 *
 * Renders POSTS (app/blog/_posts.ts, newest-first) as a responsive grid of
