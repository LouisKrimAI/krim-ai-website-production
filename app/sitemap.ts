...
const ROUTES: { path: string; priority: number; changeFrequency: Change }[] = [
  ...
  { path: '/platform/kendra', priority: 0.8, changeFrequency: 'monthly' },
  { path: '/platform/kriya', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/platform/karta', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/platform/kupa', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/platform/kula', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/platform/kira', priority: 0.7, changeFrequency: 'monthly' },
