    ...
    >
      <Reveal>
        <p className="font-sans text-body-lg text-ink-2">
          ...
          are direct about what they think this means. Intelligence, they argue, is not
        ...
        <p className="mt-5 font-sans text-body-lg text-ink-2">
          Orca learns its world in two ways, and the paper&rsquo;s vocabulary for them is striking.{' '}
        ...
        <p className="mt-5 font-sans text-body text-ink-2">
          Notice what made this possible. The physical world is, in a sense, lucky: it has
          footage. Billions of hours of it, recorded as a by-product of human life, dense enough
          for a model to learn how the world behaves just by watching. Whatever you think of any
          single paper, the direction is unmistakable, and Orca is one of several signs that the
          field&rsquo;s centre of gravity is moving toward it: modelling the state of the world
        ...
        <p className="mt-5 font-sans text-body text-ink-2">
          ...
          learn from is discarded at the moment of decision, every day, at every lender.
        </p>
        ...
        <p className="mt-5 font-sans text-body-lg text-ink-2">
          This ordering is the heart of the matter, and it is why you cannot get to an
          institutional world model by pointing a bigger network at a bank&rsquo;s data warehouse.
