...
H1: One operating system. Named for what each part does.
SUB: KrimOS isn't a product with features bolted on — it's a runtime, a vocabulary, a workforce, and two faces. Here's how they fit.
CTA: Book a demo
PRESENTATION: the full architecture, alive — Kendra glowing at the core, Kriya and Karta feeding it, Kula and Kira at the edges. This is the map; every part is a doorway.

## 2 · How it fits together
EYEBROW: THE ARCHITECTURE
H2: A vocabulary becomes a workforce, run by a mind.
...
COPY: The parts never change. Only the rules and use cases do.
CTA: Explore Kendra → · Book a demo
