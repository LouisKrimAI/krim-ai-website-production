 ...
 *
 * Beats: the logo fades in at 4.1 s, on the orb's glow zenith (~4.1–4.3 s) —
 * the mark arriving as the "mind" is at its brightest. Headline line 1 starts
 * at 5.2 s as the unfurl establishes itself (bloom begins ~3.8 s); line 2 at
 * 8.0 s lands as the ring itself resolves (8.5 s) — the line and the ring
 * settle together. The subline follows at 10.4 s and the CTAs at 12.6 s, each
        ...
        <div className="mx-auto w-full max-w-site px-6 md:px-10">
          <div className="mx-auto flex max-w-[860px] flex-col items-center text-center">
            ...
            <h1 className="font-serif text-[clamp(2.5rem,5vw,3.95rem)] leading-[1.06] tracking-[-0.02em] text-ink">
              <motion.span className="hero-failsafe block text-grad" {...f(5.2, 1.6)}>
                Sovereign Superintelligence
              </motion.span>
              <motion.span className="hero-failsafe block" {...f(8.0, 1.6)}>
                for Safe Automation
              </motion.span>
            </h1>
